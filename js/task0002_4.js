window.onload = function () {
	var arr = ["blue", "balck", "function", "click", "text", "a", "push", "border", "style", "text123", "text12", "text", "text1235678", "apple", "duck", "deep", "efe", "eco", "fuck", "friends", "google", "gmail", "host", "holp", "iefuck", "jeck", "jerk", "javascript", "king", "kind", "ko", "loop", "laugh", "mother", "moon", "noon", "node", "nodejs", "ooooook", "ok", "ofcourse", "pig", "pink", "queen", "query", "ross", "stick", "strim", "t", "ufo", "vooo", "woow", "work", "world", "xyz", "xing", "yellow", "yyyy", "zoom", "zoon", "zark"];
